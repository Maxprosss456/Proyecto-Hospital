...
const Norma = () => {
  ...
  const estilosLocales = {
    contenedorNormas: {
      ...
      gap: '20px',
      padding: '20px',
      // Forzamos que el contenedor llene el espacio disponible y añada scroll general si es necesario
      height: '100%',
    ...
    cajaTextoScroll: {
      ...
      fontSize: '13px',
      textAlign: 'justify',
      // 💡 Clave: Le damos un alto fijo y scroll individual a las cajas blancas como tu boceto
      height: '150px',
      overflowY: 'scroll'
    }
  };
